...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        likelyGhostPositions = [belief.argMax() for belief in livingGhostPositionDistributions]            
        
        bestAction = None
        closestDist = math.inf
        for action in legal:
            successorPosition = Actions.getSuccessor(pacmanPosition, action)
            minDist = min([self.distancer.getDistance(g, successorPosition) for g in likelyGhostPositions])
