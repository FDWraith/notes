...
ex_program_4 = Program [ex_globaldef_1, ex_globaldef_2] (Var "x")
...
ex_program_sexpr_4 = [ex_globaldef_sexpr_1, ex_globaldef_sexpr_2, (S.Symbol "x")]
...
test_programFromSExpression = do
  ...
  test "programFromSExpression [ \n (define x 42) \n (define x (+ 10 x)) \n x ]"
       (programFromSExpression ex_program_sexpr_4) ex_program_4
  test "programFromSExpression [ \n (define x 42) \n (defun double (y) (* 2 y) \n (double x) ]"
